...
- (void)viewDidLoad {
	...
	voucherBottom.frame = CGRectMake(0, CGRectGetMaxY(_voucherView.frame), self.view.bounds.size.width, 2.5);
	...
	[_detailsView addSubview:_titleLabel];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	if (indexPath.section == 0) {
		...
		if (_showDetails) {
			cell.textLabel.text = @"点击翻开查看代金券余额";
		} else {
			cell.textLabel.text = @"点击翻开查看使用细则";
		}
